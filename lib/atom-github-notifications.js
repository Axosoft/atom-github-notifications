    ...
    .then(([...notifications]) => Promise.all(
      R.map(
        (notification) => {
          ...
          const fetchFunction = R.cond(
            [
              [R.not(), null],
              [
                R.equals(CommentType.COMMIT),
                R.bind(github.repos.getCommitCommentAsync, github.repos),
              ],
              [
                R.equals(CommentType.PULL_REQUEST),
                R.bind(github.pullRequests.getCommentAsync, github.pullRequests),
              ],
              [R.equals(CommentType.ISSUE), R.bind(github.issues.getCommentAsync, github.issues)],
              [R.T, () => null],
            ],
            commentType,
          );
