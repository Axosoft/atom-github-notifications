...
import AtomGithubNotifications from '../lib/atom-github-notifications';
  ...
  describe('when the atom-github-notifications:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let atomGithubNotificationsElement = workspaceElement.querySelector('.atom-github-notifications');
        expect(atomGithubNotificationsElement).toExist();

        let atomGithubNotificationsPanel = atom.workspace.panelForItem(atomGithubNotificationsElement);
